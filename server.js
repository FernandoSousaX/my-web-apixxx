var config = require('./config.js');
 ...
 var empregadosModel = require('./api/models/empregadosModel');
 var empregadosRoute = require('./api/routes/empregadosRoute');
 empregadosRoute(app);

 mongoose.Promise = global.Promise;
 const connection = mongoose.connect('mongodb+srv://joni:123456Aa@cluster0-wrv44.azure.mongodb.net/cafe?retryWrites=true', { useNewUrlParser: true });
